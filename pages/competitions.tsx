...
const Competitions = () => {
  ...
  return (
    ...
    <Spline
        scene="https://prod.spline.design/i-qVC50ri3myKVpy/scene.splinecode" 
      />
  </div>

  <div className='px-20 mt-40'>
  <div>
      <h1 className='text-6xl my-10 font-bold bg-clip-text text-transparent bg-gradient-to-b from-black to-blue-600 text-center'>Competitions We have won</h1>
    </div>
  <div className="sm:p-20 w-full relative flex-wrap gap-10 flex items-center justify-center">
    ...
    <div>
      <h1 className="text-4xl font-bold md:text-4xl lg:text-6xl max-w-7xl mx-auto text-center mt-6 relative z-20 py-6 bg-clip-text text-transparent bg-gradient-to-b from-black via-blue-600 to-blue-600">
        Wanna Collaborate for <br  /> <div className='mt-4'></div> <div className='rounded-xl'><Cover className='rounded-xl'>Competitions</Cover></div>
      </h1>
