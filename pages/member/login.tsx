        ...
        <div className="max-w-xl w-full">
          ...
          <div className="p-8 rounded-2xl bg-gradient-to-b from-black via-blue-600 to-black text-center shadow">
            ...
            <form className="mt-8 space-y-4">
              ...
              <p className="text-gray-100 text-sm !mt-8 text-center">Are you a admin? <Link href="/admin/login" className="text-blue-100 hover:underline ml-1 whitespace-nowrap font-semibold">Login here</Link></p>
            </form>
          </div>
        </div>
      </div>
