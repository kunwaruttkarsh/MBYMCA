...
const Footer = () => {
  ...
  return (
    <div>
        ...
        <div className="mx-auto max-w-7xl mb-4 px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto">
                <a href="https://pagedone.io/" className="flex justify-center ">
                    <Image src={micro} alt="micro" width={200} height={200} />
                </a>
                    <ul className="text-lg flex items-center justify-center flex-col gap-7 md:flex-row md:gap-12 transition-all duration-500 py-4 mb-10 border-b border-gray-200">
                        <li><a href="#" className="text-gray-200 hover:text-gray-500">Pagedone</a></li>
                        <li><a href="#" className=" text-gray-200 hover:text-gray-500">Products</a></li>
                        <li><a href="#" className=" text-gray-200 hover:text-gray-500">Resources</a></li>
                        <li><a href="#" className=" text-gray-200 hover:text-gray-500">Blogs</a></li>
                        <li><a href="#" className=" text-gray-200 hover:text-gray-500">Support</a></li>
                    </ul>
                    <div className="flex space-x-10 justify-center items-center mb-4">
                        <a href="#" className="block  text-gray-100 transition-all duration-500 hover:text-blue-600 ">
                    ...
                    <span className="text-md text-gray-500 text-center block">©<a href="https://pagedone.io/">microbirdymca</a> 2024, All rights reserved.</span>
                    <p className='text-sm py-1 text-gray-600 text-center'> Special Credits to </p>
